...
### 事件系统
游戏开始后约 2 游戏小时（5000 ticks），自动触发奴隶商人事件：
- 商人带来希尔薇（作为囚犯）
- 支付 100 白银即可收留她
- 事件仅触发一次，确保希尔薇的独特性
...
**目标选择逻辑**:
希尔薇会选择40格范围内最合适的殖民者作为抚摸对象，选择标准如下：
- 必须是同派系殖民者（不能是访客或敌人）
- 双方好感度必须大于0（至少有些许好感）
...
- **高好感度加成**：好感度超过40时获得额外100分加成
- **心情加成**：目标心情较好（超过50%）时额外获得50分
- 系统会优先选择关系亲密且心情良好的殖民者

**效果**:
- 希尔薇获得"被温柔地抚摸了"心情效果（+10，持续16小时）
- 抚摸者获得"抚摸了希尔薇"心情效果（+6/+8，持续12小时）
  - **+6心情**：抚摸者对希尔薇的好感度 ≤ 40（普通关系）
  - **+8心情**：抚摸者对希尔薇的好感度 > 40（亲密关系）
- 双方社交关系提升（+10好感度，希尔薇低心情时额外+5）
- 触发游戏内通知消息
...
- 抚摸者的心情效果取决于其对希尔薇的好感度：好感度>40时获得+8（亲密），否则+6（普通）
...
详细技术实现请参考[开发者文档](Source/README.md)。
...
- **新增寻求抚摸功能**:
  - 希尔薇殖民者会主动寻求其他殖民者的抚摸
  - 触发条件：每小时20%概率检查，需满足年龄、状态、冷却等条件
  - 心情效果：希尔薇+10，抚摸者+6/+8
  - 社交关系：双向+10好感度（低心情时额外+5）
  - 冷却时间：6小时
